...
#ifndef NDEBUG
#define REBIRTHDB_VERSION_STR SERVER_EXEC_NAME " " REBIRTHDB_VERSION " (debug)" " (" COMPILER_STR ")"
#else
#define REBIRTHDB_VERSION_STR SERVER_EXEC_NAME " " REBIRTHDB_VERSION " (" COMPILER_STR ")"
#endif
